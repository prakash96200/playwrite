...
//
//public class ResultClassD extends base.Baseclass {
//
...
//	}
//
////	public static void logMessageScreenshot(Status status, String msg, WebDriver driver) throws Exception {
////		logMessageHtmlScreenshot(status, msg, driver);
////		logMessagePdfScreenshot(status, msg, driver);
////	}
//
////	public static void logMessageHtmlScreenshot(Status status, String msg, WebDriver driver) throws Exception {
////
////		exTest.log(status, msg, MediaEntityBuilder.createScreenCaptureFromPath(getScreenhot(driver)).build());
////
////	}
//
////	public static void logMessagePdfScreenshot(Status status, String msg, WebDriver driver) throws Exception {
...
//				+ folderName + "\\" + fileNameCompare + "\\ESurety Automation Report.html");
//	
...
//		
//				
//		ResultClass.pdf = new ExtentPDFReporter(properties.getPropValues("projectPath") + "\\Reports\\Report"
//			+ folderName + "\\" + fileNameCompare + "\\ESurety Automation Report.pdf");
...
//	}
//
////	public void logInfo(ExtentTest logger, String msg, WebDriver driver) throws Exception {
////		// TODO Auto-generated method stub
////		logMessageHtmlScreenshot(Status.INFO, msg, driver);
////		logMessagePdfScreenshot(Status.INFO, msg, driver);
////	}
//
////	public void logWarning(ExtentTest logger, String msg, WebDriver driver) throws Exception {
////		// TODO Auto-generated method stub
////		logMessageHtmlScreenshot(Status.WARNING, msg, driver);
...
//	}
//	
////	public void logBoldInfo(ExtentTest logger, String msg, WebDriver driver) throws Exception {
////		logMessageHtmlScreenshot(Status.INFO, "<b><u>" + msg + "</u></b>", driver);
////		logMessagePdfScreenshot(Status.INFO, "<b><u>" + msg + "</u></b>", driver);
////	}
//
////	public void logBoldFail(ExtentTest logger, String msg,WebDriver driver) throws Exception {
////		//logger.getStatus();
////		logMessageHtmlScreenshot(Status.FAIL,"<b><u>" + msg + "</u></b>", driver);
////		logMessagePdfScreenshot(Status.FAIL, "<b><u>" + msg +"</u></b>" , driver);
////		logger.log(Status.FAIL, msg);
////		
////	}
//
////	public void logFail(ExtentTest logger, String msg,WebDriver driver) throws Exception {
////		//logger.getStatus();
////		logMessageHtmlScreenshot(Status.FAIL, msg, driver);
////		logMessagePdfScreenshot(Status.FAIL, msg, driver);
////		//if read status =cancel, pass cancel status, else fail
////		status="Fail";
////		logger.log(Status.FAIL, msg);
////		
////	}
...
//
//
////	public void logPass(ExtentTest logger, String msg,WebDriver driver) throws Exception {
////		logMessageHtmlScreenshot(Status.PASS, "<b><u>" + msg + "</u></b>", driver);
...
//
//	
//	//***** Report for duplicate bonds
////	public void logDuplicateWarning(ExtentTest logger, String msg, WebDriver driver) throws Exception {
////		// TODO Auto-generated method stub
////		logMessageHtmlScreenshot(Status.WARNING, msg, driver);
////		logMessagePdfScreenshot(Status.WARNING, msg, driver);
////		status="Duplicate";
////	}
//	
////	public void logDuplicateWarning(ExtentTest logger, String msg) throws Exception {
////		// TODO Auto-generated method stub
////		logHtmlMessage(Status.WARNING, msg);
////		logPdfMessage(Status.WARNING, msg);
////		status="Duplicate";
////	}
//	
////	public void logDuplicateCancelWarning(ExtentTest logger, String msg) throws Exception {
////		// TODO Auto-generated method stub
////		logHtmlMessage(Status.WARNING, msg);
////		logPdfMessage(Status.WARNING, msg);
////		status="Cancelled";
